...
<html lang="en">
  ...
  <title>Sistem Informasi | Administrator</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark elevation-4" style="background-color:#000000">
    ...
    <a href="/dashboard" class="brand-link text-center">
      <span class="brand-text font-weight-light">Sistem Informasi Kritik Film</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            <img src="{{ asset('foto/foto_profil/' . Auth::user()->foto_profil) }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
